...
struct element element_searcher(char element_name[20],char element_symbol[4],int atomic_number,float atomic_weight)
{
    ...
    strcpy(atom[58].electronic_configuration,"[Xe] 4f⁴ 6s²");
    strcpy(atom[58].history,"Neodymium was discovered in Vienna in 1885 by Karl Auer. Its story began with the discovery of cerium, from which Carl Gustav Mosander extracted didymium in 1839. This turned out to be a mixture of lanthanoid elements, and in 1879, samarium was extracted from didymium, followed a year later by gadolinium.");
    atom[58].melting_point = 1,016;
    atom[58].boiling_point = 3,074;
    atom[58].ionic_radius = 229;
    atom[58].isotopes = 7;
    atom[58].electronegativity = 1.14;
    ...
    strcpy(atom[58].luster,"Metallic luster");
    strcpy(atom[58].phase,"Solid");
    atom[58].density = 7.26;
    strcpy(atom[58].uses,"Promethium is used in specialised atomic batteries. These are roughly the size of a drawing pin and are used for pacemakers, guided missiles and radios. The radioactive decay of promethium is used to make a phosphor give off light and this light is converted into electricity by a solar cell.");
    strcpy(atom[58].image_path,"");
    ...
    strcpy(atom[58].electronic_configuration,"[Xe] 4f⁶ 6s²");
    strcpy(atom[58].history,"Samarium was discovered in 1879 by the French chemist Paul-Émile Lecoq de Boisbaudran and named after the mineral samarskite from which it was isolated. ... Although classified as a rare-earth element, samarium is the 40th most abundant element in the Earth's crust and is more common than metals such as tin.");
    atom[58].melting_point = 1,072;
    atom[58].boiling_point = 1,794;
    atom[58].ionic_radius = 242;
    atom[58].isotopes = 7;
    atom[58].electronegativity = 1.17;
    strcpy(atom[58].color,"Silvery white");
    atom[58].group = 0;
    atom[58].period = 6;
    strcpy(atom[58].conductivity,"Thermal conductivity");
    strcpy(atom[58].luster,"Silver luster ");
    strcpy(atom[58].phase,"Solid");
    atom[58].density = 7.520;
    strcpy(atom[58].uses,"Samarium is used to dope calcium chloride crystals for use in optical lasers. It is also used in infrared absorbing glass and as a neutron absorber in nuclear reactors. Samarium oxide finds specialised use in glass and ceramics.");
    strcpy(atom[58].image_path,"");
    ...
    strcpy(atom[58].electronic_configuration,"Xe 4f7 6s2");
    strcpy(atom[58].history,"Europium was discovered by Eugène-Antole Demarçay, a French chemist, in 1896. Demarçay suspected that samples of a recently discovered element, samarium, were contaminated with an unknown element. He was able to produce reasonably pure europium in 1901. ... Europium is the most reactive of the rare earth elements.");
    atom[58].melting_point = 1522;
    atom[58].boiling_point = 2510;
    atom[58].ionic_radius = 240;
    atom[58].isotopes = 2;
    atom[58].electronegativity = 1.2;
    strcpy(atom[58].color,"Silvery-white");
    atom[58].group = 0;
    atom[58].period = 6;
    strcpy(atom[58].conductivity,"Electrical Conductivity");
    strcpy(atom[58].luster,"Metallic luster");
    strcpy(atom[58].phase,"Solid");
    atom[58].density = 5.25 ;
    strcpy(atom[58].uses,"Europium is excellent at absorbing neutrons, making it valuable in control rods for nuclear reactors. Europium-doped plastic has been used as a laser material. It is also used in making thin super-conducting alloys.");
    strcpy(atom[58].image_path,"");
    ...
    strcpy(atom[58].electronic_configuration,"Xe 4f7 5d1 6s2");
    strcpy(atom[58].history,"Gadolinium was discovered in 1880 by Charles Galissard de Marignac at Geneva. ... In 1880, Marignac extracted yet another new rare earth from didymium, as did Paul-Émile Lecoq de Boisbaudran in 1886, and it was the latter who called it gadolinium.");
    atom[58].melting_point = 1313;
    atom[58].boiling_point = 3272;
    atom[58].ionic_radius = 238;
    atom[58].isotopes = 17;
    atom[58].electronegativity = 1.2;
    strcpy(atom[58].color,"Silvery-white");
    atom[58].group = 0;
    ...
    strcpy(atom[58].phase,"Solid");
    atom[58].density = ;
    strcpy(atom[58].uses,"Gadolinium is an extensively used element as a contrast agent to enhance the MRI imaging. Nine different gadolinium chelates have been approved by the FDA so far. Nephrogenic systemic fibrosis (NSF) is the main toxic effect caused by the gadolinium-based contrast agents.");
    strcpy(atom[58].image_path,"");
    ...
    strcpy(atom[58].electronic_configuration,"[Xe] 4f⁶ 6s²");
    strcpy(atom[58].history,"Samarium was discovered in 1879 by the French chemist Paul-Émile Lecoq de Boisbaudran and named after the mineral samarskite from which it was isolated. ... Although classified as a rare-earth element, samarium is the 40th most abundant element in the Earth's crust and is more common than metals such as tin.");
    atom[58].melting_point = 1072;
    atom[58].boiling_point = 1794;
    atom[58].ionic_radius = 242;
    atom[58].isotopes = 7;
    atom[58].electronegativity = 1.17;
    strcpy(atom[58].color,"Silvery white");
    ...
    strcpy(atom[58].electronic_configuration,"Xe 4f10 6s2");
    strcpy(atom[58].history,"Dysprosium was discovered in 1886 by Paul-Émile Lecoq de Boisbaudran in Paris. Its discovery came as a result of research into yttrium oxide, first made in 1794, and from which other rare earths (aka lanthanoids) were subsequently to be extracted, namely erbium in 1843, then holmium in 1878, and finally dysprosium.");
    atom[58].melting_point = 1412;
    atom[58].boiling_point = 2567;
    atom[58].ionic_radius = 235;
    atom[58].isotopes = 7;
    atom[58].electronegativity = 1.22;
    strcpy(atom[58].color,"Silvery white");
    atom[58].group = 0;
    atom[58].period = 6;
    strcpy(atom[58].conductivity,"Thermal Conductivity");
    strcpy(atom[58].luster,"Bright silver luster");
    strcpy(atom[58].phase,"Solid");
    atom[58].density = 8.551;
    strcpy(atom[58].uses,"Dysprosium is used, in conjunction with vanadium and other elements, in making laser materials and commercial lighting. Because of dysprosium's high thermal-neutron absorption cross-section, dysprosium-oxide–nickel cermets are used in neutron-absorbing control rods in nuclear reactors.");
    strcpy(atom[58].image_path,"");
    ...
    strcpy(atom[58].electronic_configuration,"Xe 4f11 6s2");
    strcpy(atom[58].history,"Holmium was discovered at Geneva in 1878 by Marc Delafontaine and Louis Soret, and independently by Per Teodor Cleve at Uppsala, Sweden. ... He separated holmium from erbium in 1878. Delafontaine and Soret also extracted it from the same source, having seen unexplained lines in the atomic spectrum.");
    atom[58].melting_point = 1472;
    atom[58].boiling_point = 2695;
    atom[58].ionic_radius = 233;
    atom[58].isotopes = 36;
    atom[58].electronegativity = 1.23;
    strcpy(atom[58].color,"Silvery white");
    atom[58].group = 0;
    atom[58].period = 6;
    strcpy(atom[58].conductivity,"Thermal Conductivity");
    strcpy(atom[58].luster,"Silvery luster");
    strcpy(atom[58].phase,"Solid");
    atom[58].density = 8.8;
    strcpy(atom[58].uses,"Holmium alloys are used as a magnetic flux concentrator to create the strongest artificially-generated magnetic fields. It is also used in nuclear reactors for nuclear control rods. Holmium oxide is used as yellow gas colouring.");
    strcpy(atom[58].image_path,"");
    ...
    strcpy(atom[58].electronic_configuration,"Xe 4f12 6s2");
    strcpy(atom[58].history,"Erbium (for Ytterby, a village in Sweden) was discovered by Carl Gustaf Mosander in 1843. ... He discovered that the sample contained at least two metal oxides in addition to pure yttria, which he named "erbia" and "terbia" after the village of Ytterby where the gadolinite had been found.");
    atom[58].melting_point = 1529;
    atom[58].boiling_point = 2867;
    atom[58].ionic_radius = 232;
    atom[58].isotopes = 6;
    atom[58].electronegativity = 1.24;
    strcpy(atom[58].color,"Silvery-white");
    atom[58].group = 0;
    atom[58].period = 6;
    strcpy(atom[58].conductivity,"Thermal conductivity");
    ...
    strcpy(atom[58].electronic_configuration,"Xe 4f13 6s2");
    strcpy(atom[58].history,"Thulium was first isolated in 1879 as its oxide by Per Teodor Cleve at the University of Uppsala, Sweden. The discoveries of the many rare earth elements (aka lanthanoid) began with yttrium in 1794. This was contaminated with these chemically similar elements.");
    atom[58].melting_point = 1545;
    atom[58].boiling_point = 1730;
    atom[58].ionic_radius = 230;
    atom[58].isotopes = 35;
    atom[58].electronegativity = 1.25;
    strcpy(atom[58].color,"Silvery-gray");
    atom[58].group = 0;
    atom[58].period = 6;
    strcpy(atom[58].conductivity,"Thermal Conductivity");
    strcpy(atom[58].luster,"Silvery-gray luster");
    strcpy(atom[58].phase,"Solid");
    atom[58].density = 9.3;
    strcpy(atom[58].uses,"Thulium has been used to create lasers. When stable thulium (Tm-169) is bombarded in a nuclear reactor it can later serve as a radiation source in portable X-ray devices. It also has potential use in ceramic magnetic materials called ferrites, which are used in microwave equipment.");
    strcpy(atom[58].image_path,"");
    ...
    strcpy(atom[58].electronic_configuration,"Xe 4f14 6s2");
    strcpy(atom[58].history,"Ytterbium was isolated in 1878 by Jean Charles Galissard de Marignac at the University of Geneva. The story began with yttrium, discovered in 1794, which was contaminated with other rare-earth elements (aka lanthanoids).Even this was eventually shown to contain another rare earth, lutetium, in 1907.");
    atom[58].melting_point = 824;
    atom[58].boiling_point = 1196;
    atom[58].ionic_radius = 228;
    atom[58].isotopes = 7;
    ...
    strcpy(atom[58].phase,"Solid");
    atom[58].density = 7;
    strcpy(atom[58].uses,"Ytterbium clocks are the World's most stable atomic clock.It is used as a doping agent to improve the strength, grain refinement and mechanical properties of stainless steel.It also acts as an industrial catalyst.Few alloys of Ytterbium are used in dentistry.");
    strcpy(atom[58].image_path,"");
    ...
    strcpy(atom[58].electronic_configuration,"Xe 4f14 5d1 6s2");
    strcpy(atom[58].history,"Lutetium was discovered in 1907–08 by Austrian chemist Carl Auer von Welsbach and Georges Urbain, working independently. Urbain derived the name for the element from Lutetia, the ancient Roman name for Paris, to honour his native city.Lutetium is also found in the products of nuclear fission.");
    atom[58].melting_point = 1663;
    atom[58].boiling_point = 3402;
    atom[58].ionic_radius = 227;
    atom[58].isotopes = 2;
    atom[58].electronegativity = 1.27;
    strcpy(atom[58].color,"Silvery white");
    atom[58].group = 0;
    atom[58].period = 6;
    strcpy(atom[58].conductivity,"Thermal Conductivity");
    ...
    strcpy(atom[58].phase,"Solid");
    atom[58].density = 9.7;
    strcpy(atom[58].uses,"Lutetium oxide is used to make catalysts for cracking hydrocarbons in the petrochemical industry. Lu is used in cancer therapy and because of its long half-life, 176Lu is used to date the age of meteorites. Lutetium oxyorthosilicate (LSO) is currently used in detectors in positron emission tomography (PET).");
    strcpy(atom[58].image_path,"");
    ...
    strcpy(atom[58].electronic_configuration,"Xe 4f14 5d3 6s2");
    strcpy(atom[58].history,"Tantalum was reported as a new metal in 1802 by Anders Gustav Ekeberg at Uppsala University, Sweden. However, when William Wollaston analysed the minerals from which it had been extracted he declared it was identical to niobium which has been discovered the year previously.");
    atom[58].melting_point = 3017;
    atom[58].boiling_point = 5457;
    atom[58].ionic_radius = 220;
    atom[58].isotopes = 2;
    atom[58].electronegativity = 1.5;
    strcpy(atom[58].color,"Blue-gray");
    atom[58].group = 5;
    atom[58].period = 6;
    strcpy(atom[58].conductivity,"Thermal and Electrical Conductivity");
    strcpy(atom[58].luster,"Metallic luster");
    strcpy(atom[58].phase,"Solid");
    atom[58].density = 16.6;
    strcpy(atom[58].uses,"Tantalum is used in the electronics industry for capacitors and high power resistors. It is also used to make alloys to increase strength, ductility and corrosion resistance. The metal is used in dental and surgical instruments and implants, as it causes no immune response.");
    strcpy(atom[58].image_path,"");
    ...
    strcpy(atom[58].electronic_configuration,"[Xe] 6s² 4f¹⁴ 5d⁴");
    strcpy(atom[58].history,"Tungsten was discovered by Juan José and Fausto Elhuyar, Spanish chemists and brothers, in 1783 in samples of the mineral wolframite ((Fe, Mn)WO4).Tungsten is alloyed with steel to form tough metals that are stable at high temperatures.");
    atom[58].melting_point = 3422;
    atom[58].boiling_point = 5555;
    atom[58].ionic_radius = 210;
    atom[58].isotopes = 5;
    atom[58].electronegativity = 2.36;
    strcpy(atom[58].color,"Gunmetal gray");
    atom[58].group = 6;
    atom[58].period = 6;
    strcpy(atom[58].conductivity,"Thermal conductivity");
    strcpy(atom[58].luster,"Grayish lustre");
    strcpy(atom[58].phase,"Solid");
    atom[58].density = 19.3;
    strcpy(atom[58].uses,"Tungsten is commonly used in heavy metal alloys such as high speed steel, from which cutting tools are manufactured. It is also used in the so-called 'superalloys' to form wear-resistant coatings.");
    strcpy(atom[58].image_path,"");
    ...
    strcpy(atom[58].electronic_configuration,"Xe 4f14 5d5 6s2");
    strcpy(atom[58].history,"Rhenium is generally considered to have been discovered by Walter Noddack, Ida Noddack, and Otto Berg in Germany. In 1925 they reported that they had detected the element in platinum ore and in the mineral columbite. They also found rhenium in gadolinite and molybdenite.");
    atom[58].melting_point = 3185;
    atom[58].boiling_point = 5597;
    atom[58].ionic_radius = 205;
    atom[58].isotopes = 2;
    atom[58].electronegativity = 1.9;
    strcpy(atom[58].color,"Silvery-white");
    atom[58].group = 7;
    atom[58].period = 6;
    strcpy(atom[58].conductivity,"Thermal conductivity");
    strcpy(atom[58].luster,"Metallic luster");
    strcpy(atom[58].phase,"Solid");
    atom[58].density = 21.02;
    strcpy(atom[58].uses,"Rhenium is used as an additive to tungsten- and molybdenum-based alloys to give useful properties. These alloys are used for oven filaments and x-ray machines. It is also used as an electrical contact material as it resists wear and withstands arc corrosion.");
    strcpy(atom[58].image_path,"");
