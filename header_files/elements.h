...
struct element element_searcher(char element_name[20],char element_symbol[4],int atomic_number,float atomic_weight)
{
   ...
   atom[75].atomic_weight=190.23;
	...
	atom[80].period = 6;
        strcpy(atom[80].conductivity,"46.1 ");
    ...
    atom[82].group = 15;
    atom[82].period =6 ;
    strcpy(atom[82].conductivity,"Thermal conductivity	10 ");
    ...
    atom[83].isotopes =Polonium has 42 known isotopes, all of which are radioactive. ;
    atom[83].electronegativity =2 ;
    strcpy(atom[83].color,"silvery");
    atom[83].group =16 ;
    atom[83].period = ;
    strcpy(atom[83].conductivity," 20 ");
    ...
    atom[84].isotopes =39 known isotopes, all of which are radioactive; the range of their mass numbers is from 191 to 229. ;
    atom[84].electronegativity =2.2 ;
    strcpy(atom[84].color,"black");
    atom[84].group =17 ;
    atom[84].period = 6;
    strcpy(atom[84].conductivity,"1.7 ");
    strcpy(atom[84].luster," Metallic. Odor.");
    strcpy(atom[84].phase,"Solid");
    atom[84].density =About 7 ;
    ...
    atom[85].isotopes =There are 37 known isotopes of radon (86Rn), from 195Rn to 231Rn; all are radioactive ;
    atom[85].electronegativity =2.2 ;
    strcpy(atom[85].color,colorless"");
    atom[85].group = 18 ;
    atom[85].period =6 ;
    strcpy(atom[85].conductivity,"3.61 m ");
    strcpy(atom[85].luster," It does not have luster,");
    strcpy(atom[85].phase,"gas");
    atom[85].density =9.73  ;
    strcpy(atom[85].uses,"It is used in the treatment of cell damage and cancer. Radon is also used in radiation therapy.");
    strcpy(atom[85].image_path,"");
    ...
    atom[86].group = 1 ;
    atom[86].period = 7;
    strcpy(atom[86].conductivity,"15 W·m1·K1");
    ...
    strcpy(atom[88].conductivity,"12  ");
    ...
    atom[90].isotopes =no stable isotopes. The three naturally occurring isotopes allow a standard atomic weight to be given. ;
    ...
    atom[92].group = ;
    atom[92].period =7 ;
    strcpy(atom[92].conductivity,"6.3");
    ...
    atom[93].group =0 ;
    atom[93].period =7 ;
    strcpy(atom[93].conductivity,"6.74 ");
    ...
    atom[94].group =0 ;
    atom[94].period =7 ;
    strcpy(atom[94].conductivity,"10 ");
    ...
    atom[96].group = ;
    atom[96].period =7 ;
    strcpy(atom[96].conductivity,"10 ");
	...
	strcpy(atom[102].electronic_configuration=" [Rn] 5f147s27p1");
		strcpy(atom[102].history,"Georgy Flerov and colleagues and at Dubna, near Moscow, Russia, and independently by Albert Ghiorso and colleagues at Berkeley, California, USA");
    ...
    atom[106].density =26–27 g/cm3 (predicted) ;
    ...
    strcpy(atom[107].phase,"41 kg·cm3 (predicted)");
    atom[107].density =41 kg·cm3 (predicted) ;
    ...
    atom[108].isotopes =There are eight known isotopes, from 266Mt to 278Mt. There may also be two isomers. The longest-lived of the known isotopes is 278Mt with a half-life of 8 seconds. The unconfirmed heavier 282Mt appears to have an even longer half-life of 67 seconds. ;
