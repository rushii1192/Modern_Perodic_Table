...
struct compound *molecules_data(){
    ...
    strcpy(molecule[0].uses,"Commercial water use includes fresh water for motels, hotels, restaurants, office buildings, other commercial facilities, and civilian and military institutions. Domestic water use is probably the most important daily use of water for most people.
...
Vapours of nitric acid are condensed to a brown liquid in a receiver cooled under cold water. Dissolved oxides of nitrogen are removed by redistillation or blowing a current of carbondioxide or dry air through the warm acid.");
    ...
    strcpy(molecule[1].uses,"Industrial Uses of Nitric Acid
Nitric acid is the building block chemical for the production of many other chemical compounds. It is used in manufacturing several types of polymers like polyamides and polyurethane. Nitric acid is also commonly used as rocket propellants in the aerospace industry.

   \n Nitric Acid in Fertilizers
In fertilizer production, Nitric acid is used for manufacturing different types of nitrogenous fertilizers like calcium nitrate, ammonium nitrate, etc. Nitric acid
 is key component which is also a by product of Ammonia. \n
